 ...
 *
 * Each stamp routes to its own /mail/[plan] page (an internal Next.js
 * route, not straight to Stripe) - that page decides what to show:
 * Monthly Subscription has a full checkout form there, the other four
 * plans currently show a simple "Continue to checkout" button that then
 * goes to the plan's Stripe Payment Link. Routing everything through this
 * one page means future plans can get their own real forms built later
